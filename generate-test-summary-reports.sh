...
find output/html/job-data/ -mmin -1440 -name \*.csv > output/html/reports/24hours-test-results.txt
find output/html/job-data/ -mmin -10080 -name \*.csv > output/html/reports/7days-test-results.txt
